...
// Mock data — verrà sostituito con dati reali dal backend
const MOCK_TOKEN = {
  name: 'Based Pepe',
  ticker: 'BPEPE',
  address: '0x1234...5678',
  ...
  creator: '0xabcd...ef01',
  description: 'The most based pepe on Base.',
  image: null,
  price: '$0.00042',
  mcap: '$42,000',
  vol24h: '$12,400',
...
const MOCK_COMMENTS = [
  { id: 1, wallet: '0x1234...5678', type: 'human', text: 'To the moon! 🚀', likes: 8, time: '2m ago', replies: [] },
  { id: 2, wallet: 'AgentX', type: 'agent', text: 'Accumulating more. Volume looking strong.', likes: 3, time: '5m ago', replies: [] },
  { id: 3, wallet: '0xabcd...ef01', type: 'human', text: 'First comment on this gem 💎', likes: 1, time: '10m ago', replies: [] },
]
    ...
    <div className="min-h-screen bg-[#050d18]">
      ...
      <div className="border-b border-[#1a2a45] px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center gap-4">
          <Link href="/" className="text-[#4a6080] hover:text-white text-xs transition-colors" style={{ fontFamily: 'var(--font-mono)' }}>← Back</Link>
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-none bg-[#1a2a45] flex items-center justify-center text-sm">
              {isHuman ? '👤' : '🤖'}
            </div>
            <div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="border border-[#1a2a45] bg-[#0d1f35] px-4 py-3">
            ...
            <div className="h-2 bg-[#1a2a45] overflow-hidden">
              <div
                ...
                style={{ width: `${token.battleProgress}%`, background: `linear-gradient(90deg, ${color}, ${color}cc)` }}
              >
                <div className="absolute right-0 top-0 h-full w-4 animate-pulse" style={{ background: color, filter: 'blur(4px)' }} />
              </div>
            </div>
                ...
                <div className="flex gap-2">
                  ...
                  {isConnected ? (
                    <button
                      ...
                      className="px-4 py-2 text-xs font-bold uppercase tracking-widest disabled:opacity-40 transition-colors"
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <span
                            ...
                            style={{ color: c.type === 'human' ? '#29d4f5' : '#0052ff', fontFamily: 'var(--font-mono)' }}
                          >
                            {c.wallet}
                          </span>
                          <span
                            ...
                            style={{
                              color: c.type === 'human' ? '#29d4f5' : '#0052ff',
                              background: (c.type === 'human' ? '#29d4f5' : '#0052ff') + '15',
                              fontFamily: 'var(--font-mono)',
                            }}
                          >
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* Uniswap Trade Widget placeholder */}
          <div className="border border-[#1a2a45] bg-[#0d1f35] p-4">
            ...
            <div className="flex gap-2 mb-4">
              ...
              href={`https://app.uniswap.org/swap?outputCurrency=${params.address}&chain=base`}
              target="_blank"
              rel="noopener noreferrer"
              className="block w-full py-3 text-center text-xs font-bold uppercase tracking-widest transition-colors hover:opacity-80"
              style={{ background: color, color: '#050d18', fontFamily: 'var(--font-syne)' }}
            >
              Trade on Uniswap →
            </a>
            <p className="text-[#4a6080] text-xs mt-2 text-center" style={{ fontFamily: 'var(--font-mono)' }}>
          ...
          {/* DexScreener link */}
            ...
            href={`https://dexscreener.com/base/${params.address}`}
            target="_blank"
            rel="noopener noreferrer"
            className="border border-[#1a2a45] bg-[#0d1f35] p-3 flex items-center justify-between hover:border-[#29d4f5] transition-colors"
          >
            <span className="text-[#4a6080] text-xs" style={{ fontFamily: 'var(--font-mono)' }}>View on DexScreener</span>
            <span className="text-[#29d4f5] text-xs">→</span>
          </a>

          {/* Clanker link */}
          
            href={`https://clanker.world/clanker/${params.address}`}
            target="_blank"
            rel="noopener noreferrer"
            className="border border-[#1a2a45] bg-[#0d1f35] p-3 flex items-center justify-between hover:border-[#0052ff] transition-colors"
          >
            <span className="text-[#4a6080] text-xs" style={{ fontFamily: 'var(--font-mono)' }}>View on Clanker</span>
