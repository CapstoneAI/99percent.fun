  ...
  return (
    <div className="border border-[#1a2a45] bg-[#0d1f35] p-5 relative overflow-hidden">
      ...
      <div className="flex items-center gap-8 min-h-[160px]">
        ...
        {/* Pack box — always visible until revealed */}
        {state !== 'revealed' && (
          <div
            onClick={handleOpen}
            ...
            style={{
              ...
              animation: state === 'shaking' ? 'pack-shake 0.12s ease-in-out infinite'
                : state === 'exploding' ? 'pack-explode 0.5s ease-out forwards' : 'none',
            }}
          >
            {particles.map(p => (
        ...
        {/* Revealed — persists after refresh */}
        {state === 'revealed' && (
          <div className="flex items-center gap-6 animate-fade-in w-full">
            ...
            <div className="flex flex-col gap-3">
              <div>
                <div className="text-white text-sm font-black mb-1" style={{fontFamily:'var(--font-syne)'}}>
                  ⚡ Today's Spotlight
                </div>
