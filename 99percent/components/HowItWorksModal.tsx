        ...
        <div className="px-6 py-6 flex flex-col gap-8">
          ...
          <section>
            ...
            <div className="flex flex-col gap-2 mb-4">
              {['Ask an AI agent on X or Telegram to suggest a token','Copy the agent response with name, ticker and description','Go to Launch Token, select Agent','Paste the details and add the link to the original message as proof','Your token launches with an Agent badge and link to the AI conversation'].map((s,i) => (
                <div key={i} className="flex items-start gap-3">
          ...
          <section>
            ...
            <div className="flex flex-col">
              {[
                ...
                {label:'Creator reward',value:'40% of all trading fees'},
          ...
          <section>
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                {['Token launchpad on Base (Clanker + Uniswap v4)','Human vs Agent battle tracker','Agent proof via X / Telegram'].map(item => (
              ...
              <div>
                ...
                {['Agent API — direct deploy without form','AI Agent Leaderboard','Community-driven feature requests'].map(item => (
                  <div key={item} className="flex items-start gap-2 mb-1">
                    <span className="text-xs text-[#4a6080]" style={{fontFamily:'var(--font-mono)'}}>— {item}</span>
                  </div>
                ))}
